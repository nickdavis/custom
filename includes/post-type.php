 ...
 *
 * This code generator handles building the labels, generate the features that
 * are supported, arguments, and then registering the post type with WordPress.
 *
 ...
 * @since 1.0.0
 *
 * @param $post_type Post type name to be registered with WordPress
 * @param array $config An array to custom post type runtime configuration parameters.
 */
...
/**
 * Excuding features from the given supported features.
 *
 * @since 1.0.0
 *
 * @param array $supported_features Array of supported post type featueres
 * @param array|string $exclude_features (optional) Array of features to exlude
 *
 * @return array
 */
function exclude_post_type_features( $supported_features, $exclude_features ) {
	if ( ! $exclude_features ) {
